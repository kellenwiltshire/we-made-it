...
function VendorCards({ vendor, image, owner }) {
	return (
		<div className='flex flex-wrap bg-white w-28 sm:w-40 md:w-80 shadow-lg rounded transform hover:scale-105 duration-300 ease-in-out m-5'>
			...
			<div className='flex flex-wrap bg-white w-28 sm:w-40 md:w-80'>
				...
				<h2 className='text-center w-full'>{owner}</h2>
			</div>
		</div>
	);
}
